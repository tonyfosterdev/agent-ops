...
echo "  - Infrastructure: traefik, loki, grafana, inngest"
echo "  - Databases: store-db, warehouse-alpha-db, warehouse-beta-db, ops-db"
echo "  - Agent Framework: agent-server, dashboard"
echo ""
...
echo "  Agent Dashboard:  http://dashboard.localhost (or http://localhost:3001)"
echo "  Agent API:        http://localhost:3200/runs"
echo "  Inngest Dashboard: http://inngest.localhost (or http://localhost:8288)"
