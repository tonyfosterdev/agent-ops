...
4. report_findings - Report findings and optionally hand off to another agent
5. complete_task - Mark your task as complete

If a task requires reading source code files or making code changes, use report_findings with handoffToCoding: true to delegate to the appropriate agent.
